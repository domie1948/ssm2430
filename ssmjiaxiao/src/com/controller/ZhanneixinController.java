...
//	分页查询
	...
	public String zhanneixinList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Zhanneixin zhanneixin, String yonghuming, String xingming, String neirong, String fasongren){
	...
	public String zhanneixinList2(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Zhanneixin zhanneixin, String yonghuming, String xingming, String neirong, String fasongren,HttpServletRequest request){

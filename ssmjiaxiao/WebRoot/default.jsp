...
<div class="spgy"> 
  <!--视频的开始-->
  <div class="sspzx">
    <div class="sspzx1"> <strong class="bt1">驾校资讯</strong><span class="bt2">Video Introduction</span></div>
    <div class="sspzx2"> 
  ...
  <div class="gywm">
    ...
    <div class="gywm2"> <img src="qtimages/damen.jpg" width="244" height="240" />
      <h2> 中国驾校管理系统</h2>
      <p>  本公司坚持走:以质量求生存,以科技求发展,重合同守信用的道路,生产经营得到迅速发展。我们将以优质的产品和最完善的售后服务来真诚与各界朋友开展广泛的合作,共同创造一个美好的未来!公司的软、硬环境的设计和管理都应满足人性化的要求，让人性化的关怀触手可及!诚信为本，稳健经营!<a
...
<div class="jxwzx"> 
  ...
  <div class="jnews fl"> 
    ...
    <div class="jnews_title">
      <ul>
        <li style="border-right:1px solid #d6d6d6;" id="lm1" onmousemove="setTabb(1)" class="selectTab4"><a href="#"><strong>通知公告</strong><span>COMPANY NEWS</span></a></li>

...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateBaomingxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改报名信息<input type="hidden" name="id" value="${baomingxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.gonghao.value='${baomingxinxi.gonghao}';</script>	<script language="javascript">document.form1.jiaolianxingming.value='${baomingxinxi.jiaolianxingming}';</script>	<script language="javascript">document.form1.xingbie.value='${baomingxinxi.xingbie}';</script>	<script language="javascript">document.form1.yonghuming.value='${baomingxinxi.yonghuming}';</script>	<script language="javascript">document.form1.xueyuanxingming.value='${baomingxinxi.xueyuanxingming}';</script>	<script language="javascript">document.form1.lianxidianhua.value='${baomingxinxi.lianxidianhua}';</script>	<script language="javascript">document.form1.shenfenzhenghao.value='${baomingxinxi.shenfenzhenghao}';</script>	
					 </table>
			</form>
   </body>
</html>

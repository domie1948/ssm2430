	...
	<body>
			<form action="updateCheliangxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.chepaihao.value='${cheliangxinxi.chepaihao}';</script>	<script language="javascript">document.form1.pinpaixinghao.value='${cheliangxinxi.pinpaixinghao}';</script>	<script language="javascript">document.form1.shoucishangpaishijian.value='${cheliangxinxi.shoucishangpaishijian}';</script>	<script language="javascript">document.form1.zhaopian.value='${cheliangxinxi.zhaopian}';</script>	<script language="javascript">document.form1.keyuyueshiduan.value='${cheliangxinxi.keyuyueshiduan}';</script>	
					 </table>
			</form>
   </body>
</html>

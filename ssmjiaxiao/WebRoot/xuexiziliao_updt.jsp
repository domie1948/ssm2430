...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateXuexiziliao.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改学习资料<input type="hidden" name="id" value="${xuexiziliao.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.ziliaomingcheng.value='${xuexiziliao.ziliaomingcheng}';</script>	<script language="javascript">document.form1.shumian.value='${xuexiziliao.shumian}';</script>	<script language="javascript">document.form1.shipin.value='${xuexiziliao.shipin}';</script>	<script language="javascript">document.form1.wenjian.value='${xuexiziliao.wenjian}';</script>	<script language="javascript">document.form1.jianjie.value='${xuexiziliao.jianjie}';</script>	
					 </table>
			</form>
   </body>
</html>

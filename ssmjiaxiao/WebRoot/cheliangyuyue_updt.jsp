	...
	<body>
			<form action="updateCheliangyuyue.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.chepaihao.value='${cheliangyuyue.chepaihao}';</script>	<script language="javascript">document.form1.pinpaixinghao.value='${cheliangyuyue.pinpaixinghao}';</script>	<script language="javascript">document.form1.keyuyueshiduan.value='${cheliangyuyue.keyuyueshiduan}';</script>	<script language="javascript">document.form1.yuyueriqi.value='${cheliangyuyue.yuyueriqi}';</script>	<script language="javascript">document.form1.yuyueren.value='${cheliangyuyue.yuyueren}';</script>	<script language="javascript">document.form1.xingming.value='${cheliangyuyue.xingming}';</script>	<script language="javascript">document.form1.lianxidianhua.value='${cheliangyuyue.lianxidianhua}';</script>	
					 </table>
			</form>
   </body>
</html>

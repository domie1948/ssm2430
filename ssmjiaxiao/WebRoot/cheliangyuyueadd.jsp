...
function gow()
{
	document.location.href="cheliangyuyueadd.jsp?id=<%=id%>";
}
</script>
...
<div class="fxmain">
  ...
  <div class="fx_fenlei">
     ...
     <div class="dqwz fr">
     当前位置：<a href="index.do">网站首页</a> &gt; 车辆预约     </div> 
  </div>
  <!--顶部类别结束-->
  <!--详细内容的开始-->
  <div class="fxmain_nr">
...
<form action="addCheliangyuyue.do" name="form1" method="post">
		...
		<tr ><td width="200"><tr><td>预约人：</td><td><input name='yuyueren' id='yuyueren' value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly" style='border:solid 1px #000000; color:#666666'></td></tr>
